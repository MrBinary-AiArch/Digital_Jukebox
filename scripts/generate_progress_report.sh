#!/bin/bash
# Digital <YOUR_HOSTNAME> Progress Report (Hybrid Version)
# Generates a summary of system health, storage, and library statistics.
# Outputs to BOTH the terminal and the progress_report.log file.
...
# Function to generate the actual report content
generate_report() {
    echo "--------------------------------------------------"
...
# Execute report, pipe to log file AND print to screen
